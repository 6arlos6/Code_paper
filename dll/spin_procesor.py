...
class Quantum_Spin_Proces:
  ...
  def __init__(self, h = 1, gir = 1.760e11, B0 = 10e-3, nf = 1, N_qubits = 1, J = 1, tf_noise = False,
                 ...
                 tf_quantum_noise = False, f_rage = 0):
        self.gir = gir
        self.B0 = B0
        self.B1 = B1_offset
        self.Dt = -7
  ...
  def Hamiltonian_solve(self, tf_expect = True):
      ...
      if self.tf_noise == False:
        ...
        #if self.paralel == False and self.end_paralele == False:
        #  self.global_time += self.delt_t
        #elif self.paralel == True and self.end_paralele == False:
        #  pass
        #elif self.paralel == True and self.end_paralele == True:
        #  self.global_time += self.delt_t
        #else:
        #  pass
      else:
      ...
      if self.tf_quantum_noise:
        ...
        c_ops = []
      #print("=========================================")
      #print("Dimensiones de H0")
      #print(H0.dims)
      #print("Dimensiones de H1")
      #print(H1.dims)
      #print("Dimensiones de C1")
      #print(c_ops[0].dims)
      #print("=========================================")
